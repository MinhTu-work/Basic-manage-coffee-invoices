...
#
tongButton = Button(buttonFrame, text='Tổng', font=('arial', 16, 'bold'), bg=mau_nen, fg='blue', bd=5, width=8,command=tinhTong)
tongButton.grid(row=1, column=0, pady=55, padx=3)

hoaDonButton = Button(buttonFrame, text='Hóa Đơn', font=('arial', 16, 'bold'), bg=mau_nen, fg='blue', bd=5, width=8,command=hien_thi_bill)
hoaDonButton.grid(row=1, column=1, pady=55, padx=3)

emailButton = Button(buttonFrame, text='Email', font=('arial', 16, 'bold'), bg=mau_nen, fg='blue', bd=5, width=8,command=send_email)
emailButton.grid(row=1, column=2, pady=55, padx=3)

inHDButton = Button(buttonFrame, text='In Bill', font=('arial', 16, 'bold'), bg=mau_nen, fg='blue', bd=5, width=8,command=inHoaDon)
inHDButton.grid(row=1, column=3, pady=55, padx=0)

clearButton = Button(buttonFrame, text='Đóng', font=('arial', 16, 'bold'), bg=mau_nen, fg='blue', bd=5, width=8,command=clear)
...
timestartButton = Button(timeFrame, text='Giờ vào', font=('arial', 14, 'bold'), fg='blue',bg=mau_nen, bd=4, width=6,command=start_timer)
...
timesEndButton = Button(timeFrame, text='Giờ ra', font=('arial', 14, 'bold'), fg='blue', bg=mau_nen,bd=4, width=6,command=stop_timer)
